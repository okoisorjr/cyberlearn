            ...
            <Container>
                <Row>
                    <Col sm={12} md={12} lg={12}>
                        <Alert variant='success' style={{fontSize:'22px'}}>welcome to Lab2 - <strong>NMAP COMMAND</strong></Alert>
                    </Col>
                </Row>
                <Row>
                    <Col sm={12} md={12} lg={12}>
                        <ReactPlayer url="https://www.youtube.com/watch?v=QTAKmINxKZA" width={560} height={400} controls={true} />
                    </Col>
                </Row>
                <Row>
