            ...
            <Container>
                <Row>
                    <Col sm={12} md={12} lg={12}>
                        <Alert variant='success' style={{fontSize:'22px'}}>welcome to Lab3 - <strong>BASIC LINUX COMMAND</strong></Alert>
                    </Col>
                </Row>
                <Row>
                    <Col sm={12} md={12} lg={12}>
                        <ReactPlayer url="https://www.youtube.com/watch?v=CBvUhx3RS3k" width={560} height={400} controls={true} />
                    </Col>
                </Row>
                <Row>
                            ...
                            <Accordion>
                                ...
                                <Card>
                                    ...
                                    <Accordion.Collapse eventKey="3">
                                        <Card.Body>
                                            <Card.Title><h1 className='mt-2 mb-5'>The Nmap Command Exercise</h1></Card.Title>
                                            <Form>
                                                <Form.Group>
                                                    <Form.Label>Question 1 - <strong>What command is used to launch the nmap?</strong></Form.Label>
                                                    <InputGroup>
                                                ...
                                                <Form.Group>
                                                    <Form.Label>Question 2 - <strong>What is the nmap option to perform list versions of services running?</strong></Form.Label>
                                                    <InputGroup>
                                                ...
                                                <Form.Group>
                                                    <Form.Label>Question 3 - <strong>What option is attached to the nmap command to specify the target OS?</strong></Form.Label>
                                                    <InputGroup>
